...
/**
  ...
  \param url url of the licence content
...
@property (nonatomic, copy) NSArray<LicenceFile *> * _Nullable licences;
/**
  Present OpenSourceViewController embbeded in navigation controller
  \param from the source controller

*/
- (void)presentOpenSourceControllerFrom:(UIViewController * _Nonnull)from;
